  ...
  var n = {
    ...
    init: function (e, t) {
      ...
      (this.$el = F(t)),
        ...
        F.browser.mobile && this.$el.addClass("mobile"),
        (this.options = F.extend(!0, {}, this.getDefaultOptions(), e)),
      ...
      for (var n in this.events) {
        ...
        for (var r in o)
          if (o.hasOwnProperty(r)) {
            var s = this[o[r]];
            (s = F.proxy(s, this)),
              "" == i ? this.$el[t](a, s) : this.$el[t](a, i, s);
          }
      }
    },
    ...
    addCommentToDataModel: function (e) {
      e.id in this.commentsById ||
        ((this.commentsById[e.id] = e).parent &&
          this.getOutermostParent(e.parent).childs.push(e.id));
    },
    ...
    render: function () {
      this.dataFetched &&
        ...
        this.createComments(),
        this.options.enableAttachments && this.createAttachments(),
    ...
    createComments: function () {
      ...
      var a = F("<ul/>", { id: "comment-list", class: "main" }),
        i = [],
        o = [];
      F(this.getComments()).each(function (e, t) {
        null == t.parent ? i.push(t) : o.push(t);
      }),
        this.sortComments(i, this.currentSortKey),
        i.reverse(),
        F(i).each(function (e, t) {
          n.addComment(t, a);
        }),
        this.sortComments(o, "oldest"),
    ...
    createAttachments: function () {
      ...
      var a = F("<ul/>", { id: "attachment-list", class: "main" }),
        e = this.getAttachments();
      this.sortComments(e, "newest"),
        e.reverse(),
        F(e).each(function (e, t) {
          n.addAttachment(t, a);
        }),
    ...
    uploadAttachments: function (e, t) {
      ...
      if (o) {
        ...
        this.$el.find("ul#attachment-list").prepend(s),
          i ? t.before(l) : this.$el.find("ul#comment-list").prepend(l);
        var c = [];
        F(e).each(function (e, t) {
          ...
          (n.id += "-" + e),
            (n.content = ""),
            (n.file = t),
            (n.fileURL = "C:/fakepath/" + t.name),
            (n.fileMimeType = t.type),
            (n = a.applyExternalMappings(n)),
            c.push(n);
        }),
          a.options.uploadAttachments(
            c,
            function (e) {
              F(e).each(function (e, t) {
                ...
                e.length == o &&
                  0 == a.getTextareaContent(r).length &&
    ...
    updateToggleAllButton: function (e) {
      if (null != this.options.maxRepliesVisible) {
        ...
        if (
          (n.removeClass("togglable-reply"),
          0 === this.options.maxRepliesVisible)
        )
          var i = n;
        else i = n.slice(0, -this.options.maxRepliesVisible);
        if (
          (i.addClass("togglable-reply"),
          a.find("span.text").text() ==
            this.options.textFormatter(this.options.hideRepliesText) &&
            i.addClass("visible"),
          n.length > this.options.maxRepliesVisible)
        ) {
          if (!a.length) {
            a = F("<li/>", { class: "toggle-all highlight-font-bold" });
            var o = F("<span/>", { class: "text" }),
              r = F("<span/>", { class: "caret" });
    ...
    updateToggleAllButtons: function () {
      ...
      e.find(".comment").removeClass("visible"),
        e.children(".comment").each(function (e, t) {
      ...
      "popularity" == i
        ? e.sort(function (e, t) {
            var n = e.childs.length,
              a = t.childs.length;
            if (
              (o.options.enableUpvoting &&
                ((n += e.upvoteCount), (a += t.upvoteCount)),
              a != n)
            )
              return a - n;
    ...
    showActiveSort: function () {
      ...
      if ("attachments" != this.currentSortKey)
        t.addClass("active"), t.find("header").html(e.first().html());
      else {
    ...
    saveOnKeydown: function (e) {
      if (13 == e.keyCode) {
        ...
        if (this.options.postCommentOnEnter || t)
          F(e.currentTarget)
            .siblings(".control-row")
            .find(".save")
            .trigger("click"),
            e.stopPropagation(),
            e.preventDefault();
    ...
    checkEditableContentForChange: function (e) {
      ...
      F(t[0].childNodes).each(function () {
        ...
        t.data("before") != t.html() &&
          (t.data("before", t.html()), t.trigger("change"));
    },
    navigationElementClicked: function (e) {
      var t = F(e.currentTarget).data().sortKey;
      "attachments" != t && this.sortAndReArrangeComments(t),
        (this.currentSortKey = t),
        this.showActiveSort();
    },
    ...
    showMainCommentingField: function (e) {
      var t = F(e.currentTarget);
      t.siblings(".control-row").show(),
        t.parent().find(".close").show(),
        t.parent().find(".upload.inline-button").hide(),
        t.focus();
    },
    hideMainCommentingField: function (e) {
      ...
      this.clearTextarea(n),
        this.adjustTextareaHeight(n, !1),
        a.hide(),
        t.hide(),
        n.parent().find(".upload.inline-button").show(),
        n.blur();
    },
    ...
    textareaContentChanged: function (e) {
      ...
      t[0].scrollHeight > t.outerHeight()
        ? o.addClass("commenting-field-scrollable")
        : o.removeClass("commenting-field-scrollable");
      var r = !0,
        s = this.getTextareaContent(t, !0);
      if ((commentModel = this.commentsById[t.attr("data-comment")])) {
        var l,
          c = s != commentModel.content;
    ...
    removeCommentingField: function (e) {
      var t = F(e.currentTarget);
      t.siblings(".textarea").attr("data-comment") &&
        t.parents("li.comment").first().removeClass("edit"),
        t.parents(".commenting-field").first().remove();
    },
    ...
    putComment: function (e) {
      ...
      F.extend(o, {
        ...
        (o = this.applyExternalMappings(o));
      this.options.putComment(
        o,
        function (e) {
          var t = n.createCommentModel(e);
          delete t.childs,
            n.updateCommentModel(t),
            a.find(".close").trigger("click"),
            n.reRenderComment(t.id);
        },
        function () {
          t.addClass("enabled");
        }
    ...
    upvoteComment: function (e) {
      var t,
        ...
        i = a.upvoteCount;
      (t = a.userHasUpvoted ? i - 1 : i + 1),
        (a.userHasUpvoted = !a.userHasUpvoted),
        (a.upvoteCount = t),
        this.reRenderUpvotes(a.id);
      var o = F.extend({}, a);
      o = this.applyExternalMappings(o);
      this.options.upvoteComment(
        o,
        function (e) {
          var t = n.createCommentModel(e);
        ...
        function () {
          (a.userHasUpvoted = !a.userHasUpvoted),
            (a.upvoteCount = i),
            n.reRenderUpvotes(a.id);
        }
      );
    },
    toggleReplies: function (e) {
      var t = F(e.currentTarget);
      t.siblings(".togglable-reply").toggleClass("visible"),
        this.setToggleAllButtonText(t, !0);
    },
    replyButtonClicked: function (e) {
      ...
      if (
        (i.length && i.remove(), i.find(".textarea").attr("data-parent") != a)
      ) {
        (i = this.createCommentingFieldElement(a)),
          n.find(".child-comments").append(i);
    ...
    editButtonClicked: function (e) {
      ...
      i.attr("data-comment", n.id),
        i.append(this.getFormattedCommentContent(n, !0)),
        this.moveCursorToEnd(i);
    },
    showDroppableOverlay: function (e) {
      this.options.enableAttachments &&
    ...
    handleDragEnter: function (e) {
      ...
      t++,
        F(e.currentTarget).data("dnd-count", t),
        F(e.currentTarget).addClass("drag-over");
    },
    handleDragLeave: function (e, t) {
      var n = F(e.currentTarget).data("dnd-count");
      n--,
        F(e.currentTarget).data("dnd-count", n),
        0 == n && (F(e.currentTarget).removeClass("drag-over"), t && t());
    },
    ...
    handleDrop: function (e) {
      e.preventDefault(),
        F(e.target).trigger("dragleave"),
        this.hideDroppableOverlay(),
        this.uploadAttachments(e.originalEvent.dataTransfer.files);
    },
    ...
    createHTML: function () {
      ...
      var a = F("<div/>", {
        ...
        i = F("<i/>", { class: "fa fa-comments fa-2x" });
      if (
        (this.options.noCommentsIconURL.length &&
          (i.css(
            "background-image",
            'url("' + this.options.noCommentsIconURL + '")'
          ),
          i.addClass("image")),
        a.prepend(F("<br/>")).prepend(i),
        n.append(a),
        this.options.enableAttachments)
      ) {
        var o = F("<div/>", {
        ...
        var r = F("<div/>", {
          ...
          s = F("<i/>", { class: "fa fa-paperclip fa-2x" });
        this.options.attachmentIconURL.length &&
          (s.css(
            "background-image",
            'url("' + this.options.attachmentIconURL + '")'
          ),
          s.addClass("image")),
          r.prepend(F("<br/>")).prepend(s),
          o.append(r);
        var l = F("<div/>", { class: "droppable-overlay" }),
          c = F("<div/>", { class: "droppable-container" }),
          d = F("<div/>", { class: "droppable" }),
          p = F("<i/>", { class: "fa fa-paperclip fa-4x" });
        this.options.uploadIconURL.length &&
          (p.css(
            "background-image",
    ...
    createProfilePictureElement: function (e, t) {
      if (e) var n = F("<div/>").css({ "background-image": "url(" + e + ")" });
      else n = F("<i/>", { class: "fa fa-user" });
      return (
        n.addClass("profile-picture"),
        n.attr("data-user-id", t),
        this.options.roundProfilePictures && n.addClass("round"),
        n
      );
    },
    ...
    createCommentingFieldElement: function (e, t, n) {
      var l = this,
        a = F("<div/>", { class: "commenting-field" });
      if ((n && a.addClass("main"), t))
        var i = this.commentsById[t].profilePictureURL,
      ...
      var r = this.createProfilePictureElement(i, o),
        s = F("<div/>", { class: "textarea-wrapper" }),
        c = F("<div/>", { class: "control-row" }),
        d = F("<div/>", {
          class: "textarea",
      ...
      var p = F("<span/>", { class: "close inline-button" })
        .append(F('<span class="left"/>'))
        .append(F('<span class="right"/>'));
      if (t) {
        ...
        if (this.options.enableAttachments) {
          var u = F("<span/>", { class: "enabled upload" }),
            f = F("<i/>", { class: "fa fa-paperclip" }),
            g = F("<input/>", { type: "file", "data-role": "none" });
          F.browser.mobile || g.attr("multiple", "multiple"),
            this.options.uploadIconURL.length &&
              (f.css(
                "background-image",
                'url("' + this.options.uploadIconURL + '")'
            ...
            u.append(f).append(g),
            c.append(u.clone()),
            n && s.append(u.clone().addClass("inline-button"));
        }
      }
      var v = F("<span/>", {
        ...
        this.options.enablePinging &&
            ...
            [
              {
                ...
                template: function (e) {
                  var t = F("<div/>"),
                    ...
                    a = F("<div/>", { class: "details" }),
                    i = F("<div/>", { class: "name" }).html(e.fullname),
                    o = F("<div/>", { class: "email" }).html(e.email);
                  return (
                    e.email
                      ? a.append(i).append(o)
                      : (a.addClass("no-email"), a.append(i)),
                    t.append(n).append(a),
                    t.html()
                  );
                },
                replace: function (e) {
                  return (
                    " " +
                    l.createTagElement("@" + e.fullname, "ping", e.id, {
                      "data-user-id": e.id,
                    })[0].outerHTML +
                    " "
                  );
          ...
          (F.fn.textcomplete.Dropdown.prototype.render = function (e) {
            ...
            if (e.length) {
              var a = e[0].strategy;
              a.id
                ? this.$el.attr("data-strategy", a.id)
                : this.$el.removeAttr("data-strategy"),
                this._renderHeader(n),
                this._renderFooter(n),
                t &&
                  (this._renderContents(t),
                  this._fitToBottom(),
                  this._fitToRight(),
              ...
              this.noResultsMessage
                ? this._renderNoResultsMessage(n)
                : this.shown && this.deactivate();
            var i =
              parseInt(this.$el.css("top")) +
              l.options.scrollContainer.scrollTop();
            this.$el.css("top", i);
          ...
          (F.fn.textcomplete.ContentEditable.prototype._skipSearch = function (
            e
          ) {
            switch (e.keyCode) {
              case 9:
    ...
    createNavigationElement: function () {
      var e = F("<ul/>", { class: "navigation" }),
        t = F("<div/>", { class: "navigation-wrapper" });
      e.append(t);
      var n = F("<li/>", {
      ...
      this.options.attachmentIconURL.length &&
        ...
        r.addClass("image")),
        o.prepend(r);
      var s = F("<div/>", { class: "navigation-wrapper responsive" }),
        l = F("<ul/>", { class: "dropdown" }),
        c = F("<li/>", { class: "title" }),
        d = F("<header/>");
      return (
        c.append(d),
        ...
        e.append(s),
        t.append(n).append(a),
        l.append(n.clone()).append(a.clone()),
        (this.options.enableReplying || this.options.enableUpvoting) &&
          (t.append(i), l.append(i.clone())),
        this.options.enableAttachments && (t.append(o), s.append(o.clone())),
        this.options.forceResponsive && this.forceResponsive(),
        e
      );
    },
    createSpinner: function () {
      var e = F("<div/>", { class: "spinner" }),
        t = F("<i/>", { class: "fa fa-spinner fa-spin" });
      return (
        this.options.spinnerIconURL.length &&
          (t.css(
            "background-image",
    ...
    createCommentElement: function (e) {
      var t = F("<li/>", { "data-id": e.id, class: "comment" }).data(
        "model",
        e
      );
      e.createdByCurrentUser && t.addClass("by-current-user"),
        e.createdByAdmin && t.addClass("by-admin");
      var n = F("<ul/>", { class: "child-comments" }),
        a = this.createCommentWrapperElement(e);
      return t.append(a), null == e.parent && t.append(n), t;
    },
    createCommentWrapperElement: function (e) {
      var t = F("<div/>", { class: "comment-wrapper" }),
        ...
        i = F("<span/>", {
          ...
          text: e.createdByCurrentUser
            ? this.options.textFormatter(this.options.youText)
            : e.fullname,
        });
      e.profileURL && (i = F("<a/>", { href: e.profileURL, html: i }));
      var o = F("<div/>", { class: "name", html: i });
      if ((e.createdByAdmin && o.addClass("highlight-font-bold"), e.parent)) {
        ...
        if (r.parent) {
          var s = F("<span/>", {
            ...
            l = F("<i/>", { class: "fa fa-share" });
          this.options.replyIconURL.length &&
            (l.css(
              "background-image",
      ...
      var d = F("<div/>", { class: "wrapper" }),
        p = F("<div/>", { class: "content" }),
        m = null != e.fileURL;
      if (m) {
        var h = null,
          u = null;
        ...
        if ("image" == u) {
          ...
          0 < b.indexOf(h)
            ? (x = "fa fa-file-" + h + "-o")
            : 0 < b.indexOf(u) && (x = "fa fa-file-" + u + "-o");
          var y = F("<i/>", { class: x });
          this.options.fileIconURL.length &&
            (y.css(
              "background-image",
      ...
      var U = F("<span/>", { class: "actions" }),
        $ = F("<span/>", { class: "separator", text: "·" }),
        E = F("<button/>", {
          class: "action reply",
          type: "button",
          text: this.options.textFormatter(this.options.replyText),
        }),
        A = F("<i/>", { class: "fa fa-thumbs-up" });
      this.options.upvoteIconURL.length &&
        (A.css("background-image", 'url("' + this.options.upvoteIconURL + '")'),
        A.addClass("image"));
      var I = this.createUpvoteElement(e);
      if (
        (this.options.enableReplying && U.append(E),
        this.options.enableUpvoting && U.append(I),
        e.createdByCurrentUser || this.options.currentUserIsAdmin)
      )
      ...
      return (
        ...
        d.append(p),
        d.append(U),
        t.append(n).append(a).append(o).append(d),
        t
      );
    },
    createUpvoteElement: function (e) {
      var t = F("<i/>", { class: "fa fa-thumbs-up" });
      return (
        this.options.upvoteIconURL.length &&
          (t.css(
            "background-image",
        ...
        F("<button/>", {
          ...
          .append(F("<span/>", { text: e.upvoteCount, class: "upvote-count" }))
          .append(t)
      );
    },
    createTagElement: function (e, t, n, a) {
      ...
      return (
        t && i.addClass(t), i.val(e), i.attr("data-value", n), a && i.attr(a), i
      );
    },
    ...
    createCssDeclarations: function () {
      F("head style.jquery-comments-css").remove(),
        this.createCss(
    ...
    isAllowedToDelete: function (n) {
      if (this.options.enableDeleting) {
        var a = !0;
        return (
          this.options.enableDeletingCommentWithReplies ||
            F(this.getComments()).each(function (e, t) {
              t.parent == n && (a = !1);
            }),
          a
    ...
    setToggleAllButtonText: function (n, e) {
      ...
      e
        ? (i.text() == r ? t() : i.text(r), o.toggleClass("up"))
        : i.text() != r && t();
    },
    adjustTextareaHeight: function (e, t) {
      ...
      var n,
        a =
          1 == t ? this.options.textareaRowsOnFocus : this.options.textareaRows;
      do {
        void 0, (n = 2.2 + 1.45 * (a - 1)), e.css("height", n + "em"), a++;
        var i = e[0].scrollHeight > e.outerHeight(),
          o =
            0 != this.options.textareaMaxRows &&
            a > this.options.textareaMaxRows;
      } while (i && !o);
    },
    ...
    getTextareaContent: function (e, t) {
      var n = e.clone();
      n.find(".reply-to.tag").remove(),
        n.find(".tag.hashtag").replaceWith(function () {
    ...
    highlightTags: function (e, t) {
      return (
        this.options.enableHashtags && (t = this.highlightHashtags(e, t)),
        this.options.enablePinging && (t = this.highlightPings(e, t)),
        t
      );
    },
      ...
      if (-1 != t.indexOf("#")) {
        t = t.replace(/(^|\s)#([a-zäöüß\d-_]+)/gim, function (e, t, n) {
          return (
            t +
            (function (e) {
              return (e = a.createTagElement("#" + e, "hashtag", e))[0]
                .outerHTML;
            })(n)
          );
        });
      ...
      if (-1 != i.indexOf("@")) {
        F(Object.keys(a.pings)).each(function (e, t) {
          ...
          i = i.replace(
            new RegExp(n, "g"),
            (function (e, t) {
              return o.createTagElement(e, "ping", t, { "data-user-id": t })[0]
                .outerHTML;
            })(n, t)
          );
        });
    ...
    linkify: function (e) {
      var t, n, a, i;
      if (
        ((n = /(\b(https?|ftp|file):\/\/[-A-ZÄÖÅ0-9+&@#\/%?=~_|!:,.;]*[-A-ZÄÖÅ0-9+&@#\/%=~_|])/gim),
        (a = /(^|[^\/f])(www\.[-A-ZÄÖÅ0-9+&@#\/%?=~_|!:,.;]*[-A-ZÄÖÅ0-9+&@#\/%=~_|])/gim),
        (i = /(([A-ZÄÖÅ0-9\-\_\.])+@[A-ZÄÖÅ\_]+?(\.[A-ZÄÖÅ]{2,6})+)/gim),
        (t = (t = (t = e.replace(
          n,
          '<a href="$1" target="_blank">$1</a>'
        )).replace(a, '$1<a href="https://$2" target="_blank">$2</a>')).replace(
          i,
          '<a href="mailto:$1">$1</a>'
        )),
        0 < (e.match(/<a href/g) || []).length)
      ) {
        for (var o = e.split(/(<\/a>)/g), r = 0; r < o.length; r++)
          null == o[r].match(/<a href/g) &&
            (o[r] = o[r]
              .replace(n, '<a href="$1" target="_blank">$1</a>')
              .replace(a, '$1<a href="https://$2" target="_blank">$2</a>')
              .replace(i, '<a href="mailto:$1">$1</a>'));
        return o.join("");
      }
      return t;
    },
